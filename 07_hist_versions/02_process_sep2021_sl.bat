...
rem --- Export for Inge with bigger extent
rem opalsExport -inf 02_intermediate\ALS_all.odm -outf 02_intermediate\ALS1_all_basic.txt -oformat oformat_basic.xml -filter "Region[03_region\new_study_area.shp]"
...
rem --- Export for Inge with bigger extent
rem set LIM=-limit "(546040.000,7614380.000,567040.000,7633510.000)"
...
rem --- Export for Inge with bigger extent
rem opalsExport -inf 02_intermediate\ALS1_all_echotypes_SOR_terrain_classified.odm -outf 04_check\TVC_ALS_2018b_roi_trees_tvc_2.las -oformat oformat_pangaea_las.xml -limit 546040 7614380 567040 7633510
