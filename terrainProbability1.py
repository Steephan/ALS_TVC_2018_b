...
def main():
	...
	ax.scatter(data[:,0], data[:,1], color="gray", s=15.0,  alpha=0.4, label='Data')
        ax.text(0.1, 0.65, 'fit: a=%5.3f, b=%5.3f, c=%5.3f' % tuple(popt), transform=ax.transAxes)
	...
	#plt.show()
	figname="05_plots/scatter_terrain_probability121.png"
	...
	c=0
	p=5
	outfile= "02_intermediate/" + basename + "_terrainprob1.txt"
